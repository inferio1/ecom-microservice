...
public class KeyCloakAdminService {
    ...
    public String getAdminAccessToken()
    {
        ...
        ResponseEntity<Map> response=restTemplate.postForEntity("http://localhost:8443/realms/ecom-app/protocol/openid-connect/token",entity,Map.class);
        return (String)response.getBody().get("access_token");
    }
    public String creaeUser(String token, UserRequest userRequest)
    {
        HttpHeaders headers=new HttpHeaders();
    ...
    private Map<String,Object> getRealmRoleRepresentation(String token,String roleName)
    {
        ...
        String url=keyCloakServiceUrl+"/admin/realms/"+realm+"/clients/"+clientUid+"/roles/"+roleName;
    ...
    public void assignRealmRoleToUser(String username,String roleName,String userId)
    {
        ...
        String url=keyCloakServiceUrl+"/admin/realms/"+realm+"/users/"+userId+"/role-mappings/clients/"+clientUid;
